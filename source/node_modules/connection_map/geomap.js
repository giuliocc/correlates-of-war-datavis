class GeoMap {
	...
	constructor(arg) {
		...
		this.color = d3.scaleOrdinal(["lightyellow", "indianred"]);
	...
	setDataset(data) {
		...
		this.elements = this.elements.enter()
			...
			.merge(this.elements)
			.attr("d", this.path)
			.attr("fill", function(d, i) { return that.color("lightyellow"); })
